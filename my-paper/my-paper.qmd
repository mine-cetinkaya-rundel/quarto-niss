---
title: "My awesome paper on penguins"
format:
  jasa-pdf:
    keep-tex: true  
    journal:
...
-   In document front matter, you may set the key `blinded` under a `journal` key to hide the authors and acknowledgements, producing the required anonymized version.[@afresh]
