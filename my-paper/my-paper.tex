...
\hypersetup{
  pdftitle={My awesome paper on penguins},
...
\date{April 7, 2023}
\title{\bf My awesome paper on penguins}
\author{
...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, sharp corners, interior hidden, breakable, frame hidden]}{\end{tcolorbox}}\fi
...
\item
  ...
  producing the required anonymized version.\citep{afresh}
\item
